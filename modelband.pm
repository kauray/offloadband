...
formula pcpuserver4g = 5;
formula pcpuserver5glow = 40;
formula pcpuserver5gmmwave = 80;
...
module selectband
    ...
    [band4g]  turn = 0 & execution = 0 & temp <= threshold -> (execution' = 0) & (turn' = 1);
    [band5glow]  turn = 0 & execution = 0 & temp <= threshold -> (execution' = 1) & (turn' = 1);
    [band5gmmwave]  turn = 0 & execution = 0 & temp <= threshold -> (execution' = 2) & (turn' = 1);
    
    [band4g]  turn = 0 & execution = 0 & temp > threshold -> (execution' = 0) & (turn' = 1);
    
    [band4g]  turn = 0 & execution = 1 & temp <= threshold -> (execution' = 0) & (turn' = 1);
    [band5glow]  turn = 0 & execution = 1 & temp <= threshold -> (execution' = 1) & (turn' = 1);
    [band5gmmwave]  turn = 0 & execution = 1 & temp <= threshold -> (execution' = 2) & (turn' = 1);
    
    [band4g]  turn = 0 & execution = 1 & temp > threshold -> (execution' = 0) & (turn' = 1);
    
    [band4g]  turn = 0 & execution = 2 & temp <= threshold -> (execution' = 0) & (turn' = 1);
    [band5glow]  turn = 0 & execution = 2 & temp <= threshold -> (execution' = 1) & (turn' = 1);
    [band5gmmwave]  turn = 0 & execution = 2 & temp <= threshold -> (execution' = 2) & (turn' = 1);
...
module device
    ...
    [update4g] turn = 1  & dtime < tmax & execution = 0-> 
	(turn' = 0) & (dtime' = dtime + 1);
	
    [update5glow] turn = 1 & dtime < tmax & execution = 1-> 
	(turn' = 0) & (dtime' = dtime + 1);
	
    [update5gmmwave] turn = 1 & dtime < tmax & execution = 2-> 
	(turn' = 0) & (dtime' = dtime + 1);
...
module server
    ...
    [update4g] turn = 1 & execution = 0 & dtime < tmax ->
	 p31 : (latency' = 0)  + p32 : (latency' = 1) + p33 : (latency' = 2) + p34 : (latency' = 3) + p35 : (latency' = 4);

    [update5glow] turn = 1 & execution = 1 & dtime < tmax ->
	 p31 : (latency' = 0)  + p32 : (latency' = 1) + p33 : (latency' = 2) + p34 : (latency' = 3) + p35 : (latency' = 4);

    [update5gmmwave] turn = 1 & execution = 2 & dtime < tmax->
	 p31 : (latency' = 0)  + p32 : (latency' = 1) + p33 : (latency' = 2) + p34 : (latency' = 3) + p35 : (latency' = 4);
endmodule
...
rewards "energy"
    [update4g] true : 300;
    [update5glow] true : 200;
    [update5gmmwave] true : 100;
endrewards
...
rewards "eqlatency"
    [update4g] latency > 0 : 300 + (1/latency);
    [update4g] latency = 0 : 300 + 1;
    [update5glow] latency > 0 : 200 + (1/latency);
    [update5glow] latency = 0 : 200 + 1;
    [update5gmmwave] latency > 0 : 100 + (1/latency);
    [update5gmmwave] latency = 0 : 100 + 1;
