...
module offloadchoice
    ...
    [retaindevice] turn = 0 & mod(dtime,k) = 0 & execution = 0 & tmig = 0 & temp1 < 50 & temp2 < 50 -> (tmig' = 0) & (execution' = 0) & (turn' = 1); // retain
...
rewards "eqlatency"
    latency = 0 : 1 + batteryenergy;
    latency = 1 : (1/latency) + batteryenergy;
    latency = 2 : (1/latency) + batteryenergy;
    latency = 3 : (1/latency) + batteryenergy;
    latency = 4 : (1/latency) + batteryenergy;
    tmig = 1 | tmig = 2 : -1;
    mig = 1 | mig = 2 : -1;
